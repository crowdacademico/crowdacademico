...
// O endpoint de remoção existe porque 06_grants.sql [06-C-1] e 04_rls_policies.sql (pol_area_delete) concedem
// DELETE em area_conhecimento ao app_nestjs, gated pela mesma permissão do update
// (area_conhecimento_gerenciar). Área de conhecimento pode ser referenciada por campanha (FK simples, sem
// CASCADE): o service.remove traduz a violação de FK num 409 com mensagem própria em vez de deixar vazar o 400
// genérico do filtro global; desativar via Alterar continua sendo a opção quando a área está em uso.
@Module({
  controllers: [
