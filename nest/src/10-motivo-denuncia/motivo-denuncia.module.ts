...
// O endpoint de remoção existe porque 06_grants.sql [06-C-1] e 04_rls_policies.sql (pol_motivo_delete) concedem
// DELETE em motivo_denuncia ao app_nestjs, gated pela mesma permissão do update (motivo_denuncia_gerenciar).
// motivo_denuncia pode ser referenciado por denuncia (FK_DENUNCIA_MOTIVO, sem CASCADE): o service.remove traduz
// a violação de FK num 409 com mensagem própria; desativar via Alterar continua sendo a opção quando o motivo
// está em uso.
@Module({
  controllers: [
