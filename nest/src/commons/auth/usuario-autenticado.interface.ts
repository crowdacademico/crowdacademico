...
export interface UsuarioAutenticado {
  idUsuario: number;
  // Vem do claim `sid` do JWT (ver auth.service.login.ts, emitirTokens). Sem isso não dá para saber QUAL
  // sessao.id_sessao corresponde à aba/dispositivo atual (o access token nunca é comparado contra `sessao`, só
