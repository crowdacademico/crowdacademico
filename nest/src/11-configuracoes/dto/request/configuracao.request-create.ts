...
export class ConfiguracaoRequestCreate {
  ...
  // true = linha global fica visível para qualquer um (mesmo sem 'configuracao_gerenciar'); false/ausente = só
  // quem tem a permissão vê (cai no DEFAULT FALSE do banco). Sem efeito numa linha pessoal (id_usuario
  // preenchido): essa já é visível só para o dono, com ou sem esta flag.
  @IsOptional()
  @IsBoolean()
  publica?: boolean;
}
