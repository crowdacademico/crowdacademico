// Separado de busca-global.tsx de propósito (mesmo motivo de toast-context.js
// estar separado de toast-provider.tsx) - um arquivo que só exporta
...
// Usado por admin-sidebar.tsx pro botão visível "Buscar" - Ctrl+K sozinho
// não é descobrível pra quem não sabe que existe.
export function abrirBuscaGlobal(): void {
