...
--  achado de uma IA - Postgres não cria índice automático em FK, e 16 das
...
-- [02-C] CONFIG
-- ============================================================
-- ADICIONADO (28-07-2026, uma IA - "Problema 3", varredura das 56 FKs contra
...
-- ADICIONADO (28-07-2026, uma IA - "Problema 3"): RNF-007 (auditoria
