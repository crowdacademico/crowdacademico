...
-- 24-09-2026: metas das campanhas 2 e 5 ajustadas para não passarem de arrecadado 28.500 e 22.000 (antes 35.000 e 30.000,
-- "sucesso" abaixo da meta, estado que o próprio banco proíbe no caminho automático).
