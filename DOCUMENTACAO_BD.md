...
* **Sem função simétrica de reativação, de propósito nesta rodada** — ver item 60 em `PENDENCIAS e correcoes.md`: hoje uma suspensão é permanente na prática, decisão em aberto se deveria ser reversível.
