...
* **[07-C-5] `configuracoes` (parâmetros de sistema):** este bloco só pode rodar depois de `[07-D-1]` (`usuario`) porque uma das suas linhas (`notificar_novas_campanhas`) tem `id_usuario = 1`, referenciando o usuário Admin do seed (ATUALIZADO 07-08-2026: Admin virou o 1º usuário inserido, ver [07-D-1]).
